    ...
    categories = [
        ...
        },
        {
            ...
            'products': [
                ...
                {
                    'name': 'Водопонижение открытым водоотливом',
                    'description': 'Услуга водопонижения методом открытого водоотлива. Подходит для объектов с большим притоком поверхностных вод. Включает установку насосного оборудования и отвод воды. Стоимость указана за 1 месяц работы.',
                    'price': 320000,
                    'image': 'products/open-dewatering.jpg'
                },
                {
